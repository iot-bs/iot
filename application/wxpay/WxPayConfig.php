...
class WxPayConfig
{
     ...
     * @var string
     */
    const APPID = 'wxcf7ce9c5ff094a21';
    const MCHID = '1304214601';
    const KEY = 'N49fBqCmVwtTOJxSH4IALJduJYK2GwOP';
    const APPSECRET = '1267431c58a4c36fe1af65c29f6f801d';
    const NOTIFY_URL = '';
     ...
     * @var string path
     */
    const SSLCERT_PATH = '/website/iot/extend/wxpay/cert/apiclient_cert.pem';
    const SSLKEY_PATH = '/website/iot/extend/wxpay/cert/apiclient_key.pem';
